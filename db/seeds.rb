...
ActiveRecord::Base.transaction do
  ...
  juice_album_1 = Album.create(user_id: juice.id, name: "Family", description: "juice's awesome album 1 description")
  juice_album_2 = Album.create(user_id: juice.id, name: "Architecture", description: "juice's awesome album 2 description")
  juice_album_3 = Album.create(user_id: juice.id, name: "Nature", description: "juice's awesome album 3 description")
  juice_album_4 = Album.create(user_id: juice.id, name: "Friends", description: "juice's awesome album 4 description")

  lisa_album_1 = Album.create(user_id: lisa.id, name: "Favorite Photos", description: "lisa's awesome album 1 description")
  lisa_album_2 = Album.create(user_id: lisa.id, name: "Memories", description: "lisa's awesome album 2 description")
  lisa_album_3 = Album.create(user_id: lisa.id, name: "Industrial", description: "lisa's awesome album 3 description")
  lisa_album_4 = Album.create(user_id: lisa.id, name: "Selfies", description: "lisa's awesome album 4 description")
  
  josh_album_1 = Album.create(user_id: josh.id, name: "Awesome", description: "josh's awesome album 1 description")
  josh_album_2 = Album.create(user_id: josh.id, name: "Cityscapes", description: "josh's awesome album 2 description")
  josh_album_3 = Album.create(user_id: josh.id, name: "Personal", description: "josh's awesome album 3 description")

  tony_album_1 = Album.create(user_id: tony.id, name: "Artistic", description: "tony's awesome album 1 description")
  tony_album_2 = Album.create(user_id: tony.id, name: "Creative Photos", description: "tony's awesome album 2 description")
  tony_album_3 = Album.create(user_id: tony.id, name: "Inspirational Album", description: "josh's awesome album 3 description")

  nicole_album_1 = Album.create(user_id: nicole.id, name: "Interesting", description: "nicole's awesome album 1 description")
  nicole_album_2 = Album.create(user_id: nicole.id, name: "Random", description: "nicole's awesome album 2 description")
  nicole_album_3 = Album.create(user_id: nicole.id, name: "My Favorites", description: "nicole's awesome album 3 description")
  ...
  album_photo_8 = AlbumPhoto.create!(photo_id: lisa_photo_2.id, album_id: lisa_album_3.id)
  album_photo_9 = AlbumPhoto.create!(photo_id: lisa_photo_4.id, album_id: lisa_album_3.id)
  album_photo_10 = AlbumPhoto.create!(photo_id: lisa_photo_2.id, album_id: lisa_album_4.id)
  album_photo_11 = AlbumPhoto.create!(photo_id: lisa_photo_6.id, album_id: lisa_album_4.id)
  album_photo_12 = AlbumPhoto.create!(photo_id: lisa_photo_5.id, album_id: lisa_album_4.id)
  album_photo_13 = AlbumPhoto.create!(photo_id: lisa_photo_1.id, album_id: lisa_album_4.id)
  ...
  album_photo_34 = AlbumPhoto.create!(photo_id: tony_photo_4.id, album_id: tony_album_1.id)
  album_photo_35 = AlbumPhoto.create!(photo_id: tony_photo_6.id, album_id: tony_album_1.id)
  album_photo_36 = AlbumPhoto.create!(photo_id: tony_photo_3.id, album_id: tony_album_1.id)
  album_photo_37 = AlbumPhoto.create!(photo_id: tony_photo_2.id, album_id: tony_album_1.id)
  album_photo_38 = AlbumPhoto.create!(photo_id: tony_photo_1.id, album_id: tony_album_2.id)
  album_photo_39 = AlbumPhoto.create!(photo_id: tony_photo_6.id, album_id: tony_album_2.id)
  album_photo_40 = AlbumPhoto.create!(photo_id: tony_photo_3.id, album_id: tony_album_2.id)
  album_photo_41 = AlbumPhoto.create!(photo_id: tony_photo_8.id, album_id: tony_album_2.id)
  album_photo_42 = AlbumPhoto.create!(photo_id: tony_photo_9.id, album_id: tony_album_3.id)
  album_photo_43 = AlbumPhoto.create!(photo_id: tony_photo_2.id, album_id: tony_album_3.id)
  album_photo_44 = AlbumPhoto.create!(photo_id: tony_photo_11.id, album_id: tony_album_3.id)
  album_photo_45 = AlbumPhoto.create!(photo_id: tony_photo_10.id, album_id: tony_album_3.id)
