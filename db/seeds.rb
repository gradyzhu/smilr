...
#lisa photo comments
  ...
  photo_tag_1 = PhotoTag.create!(photo_id:1, tag_id:1)
  photo_tag_2 = PhotoTag.create!(photo_id:2, tag_id:1)
  photo_tag_3 = PhotoTag.create!(photo_id:3, tag_id:1)
  photo_tag_4 = PhotoTag.create!(photo_id:4, tag_id:2)
  photo_tag_5 = PhotoTag.create!(photo_id:5, tag_id:2)
  photo_tag_6 = PhotoTag.create!(photo_id:6, tag_id:2)
  photo_tag_7 = PhotoTag.create!(photo_id:7, tag_id:3)
  photo_tag_8 = PhotoTag.create!(photo_id:8, tag_id:3)
  photo_tag_9 = PhotoTag.create!(photo_id:9, tag_id:3)
  photo_tag_10 = PhotoTag.create!(photo_id:10, tag_id:4)
  photo_tag_11 = PhotoTag.create!(photo_id:11, tag_id:4)
  photo_tag_12 = PhotoTag.create!(photo_id:12, tag_id:4)
  photo_tag_13 = PhotoTag.create!(photo_id:13, tag_id:5)
  photo_tag_14 = PhotoTag.create!(photo_id:14, tag_id:5)
  photo_tag_15 = PhotoTag.create!(photo_id:15, tag_id:5)
  photo_tag_16 = PhotoTag.create!(photo_id:15, tag_id:6)
  photo_tag_17 = PhotoTag.create!(photo_id:14, tag_id:6)
  photo_tag_18 = PhotoTag.create!(photo_id:13, tag_id:6)
  photo_tag_19 = PhotoTag.create!(photo_id:12, tag_id:7)
  photo_tag_20 = PhotoTag.create!(photo_id:11, tag_id:7)
  photo_tag_21 = PhotoTag.create!(photo_id:10, tag_id:7)
  photo_tag_22 = PhotoTag.create!(photo_id:9, tag_id:8)
  photo_tag_23 = PhotoTag.create!(photo_id:8, tag_id:8)
  photo_tag_24 = PhotoTag.create!(photo_id:7, tag_id:8)
  photo_tag_25 = PhotoTag.create!(photo_id:6, tag_id:9)
  photo_tag_26 = PhotoTag.create!(photo_id:5, tag_id:9)
  photo_tag_27 = PhotoTag.create!(photo_id:4, tag_id:9)
  photo_tag_28 = PhotoTag.create!(photo_id:3, tag_id:10)
  photo_tag_29 = PhotoTag.create!(photo_id:2, tag_id:10)
  photo_tag_30 = PhotoTag.create!(photo_id:1, tag_id:10)
  photo_tag_31 = PhotoTag.create!(photo_id:17, tag_id:15)
  photo_tag_32 = PhotoTag.create!(photo_id:18, tag_id:16)
  photo_tag_33 = PhotoTag.create!(photo_id:19, tag_id:14)
  photo_tag_34 = PhotoTag.create!(photo_id:20, tag_id:13)
  photo_tag_35 = PhotoTag.create!(photo_id:18, tag_id:12)
  photo_tag_36 = PhotoTag.create!(photo_id:17, tag_id:11)
  photo_tag_37 = PhotoTag.create!(photo_id:20, tag_id:10)
  photo_tag_38 = PhotoTag.create!(photo_id:19, tag_id:14)
  photo_tag_39 = PhotoTag.create!(photo_id:20, tag_id:17)
  photo_tag_40 = PhotoTag.create!(photo_id:22, tag_id:19)
  photo_tag_41 = PhotoTag.create!(photo_id:21, tag_id:12)
  photo_tag_42 = PhotoTag.create!(photo_id:25, tag_id:4)
  photo_tag_43 = PhotoTag.create!(photo_id:32, tag_id:24)
  photo_tag_44 = PhotoTag.create!(photo_id:34, tag_id:25)
  photo_tag_45 = PhotoTag.create!(photo_id:23, tag_id:23)
  photo_tag_46 = PhotoTag.create!(photo_id:22, tag_id:22)
  photo_tag_47 = PhotoTag.create!(photo_id:21, tag_id:21)
  photo_tag_48 = PhotoTag.create!(photo_id:12, tag_id:24)
  photo_tag_49 = PhotoTag.create!(photo_id:14, tag_id:18)
  photo_tag_50 = PhotoTag.create!(photo_id:12, tag_id:17)
  photo_tag_51 = PhotoTag.create!(photo_id:17, tag_id:15)
  photo_tag_52 = PhotoTag.create!(photo_id:18, tag_id:14)
  photo_tag_53 = PhotoTag.create!(photo_id:19, tag_id:12)
  photo_tag_54 = PhotoTag.create!(photo_id:24, tag_id:11)
  photo_tag_55 = PhotoTag.create!(photo_id:1, tag_id:26)
  photo_tag_56 = PhotoTag.create!(photo_id:4, tag_id:24)
  photo_tag_57 = PhotoTag.create!(photo_id:3, tag_id:25)
  photo_tag_58 = PhotoTag.create!(photo_id:2, tag_id:22)
  photo_tag_59 = PhotoTag.create!(photo_id:18, tag_id:21)
  photo_tag_60 = PhotoTag.create!(photo_id:12, tag_id:18)
end
